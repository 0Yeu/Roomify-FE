...
export const PATTERN_PASSWORD: RegExp = /[a-z0-9]{5,}/i;
...
export const NumberValidator = (value: string): boolean => !!value && value.length > 0 && !Number.isNaN(value) && !Number.isNaN(parseFloat(value));
